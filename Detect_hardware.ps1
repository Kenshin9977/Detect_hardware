...
for ($i=1;$i -lt $gpus.length; $i++) {
	...
	if ($gpus[$i] -match "^NVIDIA (GeForce (GTX (1050|1050 Ti|1060|1070|1070 Ti|1080|1080 Ti|1650))|Quadro (P1000|P2000|P400|P4000|P5000|P600|P6000)|TITAN (X|Xp|V)|(P4|V100) GPU Accelerator)( \d+GB)?$")
		{$nvenc_gen_5 = $true}
	if ($gpus[$i] -match "^NVIDIA (GeForce (GTX (1650( Max-Q)?|1650 SUPER|1660|1660 SUPER|1660Ti( Max-Q)?)|RTX (2060|2060 SUPER|2070( Max-Q)?|2070 SUPER|2080( Max-Q)?|2080 SUPER|2080 Ti|3060|3060 Ti|3070|3080|3080 Ti|3090))|Quadro (T1000|T2000|RTX 3000|RTX 4000|RTX 5000|RTX 6000|RTX 8000))$")
		{$nvenc_gen_6 = $true}
	...
	if ($gpus[$i] -match "^Intel (HD Graphics (500|505|510|515|520|530|P530)|Iris Graphics (540|550)|Iris Pro Graphics (P555|P580|580))$")
		{$qsv_gen_4 = $true}
	if ($gpus[$i] -match "^Intel (HD Graphics (610|615|620|630)|Iris Plus Graphics (640|650|655)|UHD Graphics (600|605|610|620|630|730|750))$")
		{$qsv_gen_5 = $true}
